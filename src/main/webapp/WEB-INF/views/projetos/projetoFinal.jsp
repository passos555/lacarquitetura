						...
						<table class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<c:forEach items="${fasesProjetoFinal1 }" var="fase">
								...
								<tbody>
									...
									<tr>
										...
										<input type="hidden" value="${fase.idFase }" id="idFase"/> 
											<td>
												<select class="form-control select2 select2-hidden-accessible " onChange="setStatus(this, ${count.index }, 'Final1');" style="width: 100%;" tabindex="-1" aria-hidden="true">
									...
									<tr>
										...
										<c:forEach items="${fasesProjetoFinal1 }" var="fase" varStatus="count">
											<td><input type="text" id="responsavelFinal1${count.index }" name="ultimoResponsavel" class="form-control" readonly value="${fase.ultimoResponsavel.nome }" /></td>
										</c:forEach>
									</tr>
									<tr>
										<td style="font-weight: 600;">Data de alteração</td>
										<c:forEach items="${fasesProjetoFinal1 }" var="fase" varStatus="count">
											<td><input type="text" name="dataAlteracao" id="dataAlteracaoFinal1${count.index }" class="form-control" readonly value="${fase.dataAlteracao }" /></td>
										</c:forEach>
									</tr>
								</tbody>
							</table>
